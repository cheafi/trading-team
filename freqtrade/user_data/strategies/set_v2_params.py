#!/usr/bin/env python3
"""Set pro best_params with MFE-calibrated SL (wider)."""
import json

bp = {
    "0": {
        "c": 0.62, "e": -0.05, "strategy": "A31",
        "roi_table": {"0": 0.015, "30": 0.010, "60": 0.006, "120": 0.003},
        "sl": -0.012, "trailing_offset": 0.0076,
        ...
        "trail_start": 0.008, "trail_step": 0.004,
        "cooldown_after_losses": 5, "daily_loss_limit": 0.03,
        "trade_count": 184, "max_dd": 0.01,
    },
    "1": {
        "c": 0.10, "e": -0.03, "strategy": "A51",
        "roi_table": {"0": 0.008, "30": 0.006, "60": 0.004, "120": 0.002},
        "sl": -0.010, "trailing_offset": 0.0,
        "entry_adj": 1.0, "size_adj": 1.0,
        "best_session": None, "worst_session": None,
        "direction_bias": "neutral", "bias_strength": 0.0,
    ...
    "2": {
        "c": 0.11, "e": 0.00, "strategy": "A51",
        "roi_table": {"0": 0.005, "30": 0.004, "60": 0.003, "120": 0.002},
        "sl": -0.008, "trailing_offset": 0.0,
        "entry_adj": 1.0, "size_adj": 1.0,
        "best_session": None, "worst_session": None,
        "direction_bias": "neutral", "bias_strength": 0.0,
    ...
    "3": {
        "c": 0.27, "e": -0.05, "strategy": "A31",
        "roi_table": {"0": 0.016, "30": 0.010, "60": 0.006, "120": 0.003},
        "sl": -0.012, "trailing_offset": 0.008,
        "entry_adj": 1.0, "size_adj": 1.0,
        "best_session": None, "worst_session": None,
        "direction_bias": "neutral", "bias_strength": 0.0,
...
print("Pro best_params saved with wider SL + MFE trail")
for rid in ["0", "1", "2", "3"]:
    p = bp[rid]
    print(f"  R{rid}: {p['strategy']} SL={p['sl']} trail={p['trail_start']}")
